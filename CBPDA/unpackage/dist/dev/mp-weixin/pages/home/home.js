...
var _home = _interopRequireDefault(__webpack_require__(/*! ./pages/home/home.vue */ 144));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _home_vue_vue_type_template_id_92bb8f34___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home.vue?vue&type=template&id=92bb8f34& */ 145);
/* harmony import */ var _home_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home.vue?vue&type=script&lang=js& */ 147);
...
try {
  components = {
    uSwiper: function() {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-swiper/u-swiper */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-swiper/u-swiper")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-swiper/u-swiper.vue */ 295))
    },
    uGrid: function() {
...
var _default =
{
  ...
  methods: {
    ...
    getBoxType: function getBoxType() {var _this5 = this;
      var opts = {
        url: "",
        method: 'post' };
      ...
      this.$http.httpRequest(opts, param).then(function (res) {
        if (res.data.code === "200") {
          ...
          if (res.data.data.BOX.length != 0) {
            for (var i in res.data.data.BOX) {
              typeList.push({
          ...
          _this5.types = typeList;
        } else {
          _this5.$toast.showToast("获取检测机构失败，请刷新页面");

        }
      });
    },
    getBoxStatus: function getBoxStatus() {var _this6 = this;
      var opts = {
        url: "",
        method: 'post' };
      ...
      this.$http.httpRequest(opts, param).then(function (res) {
        if (res.data.code === "200") {
          ...
          if (res.data.data.MASTER_BOX_STATUS.length != 0) {
            for (var i in res.data.data.MASTER_BOX_STATUS) {
              statusList.push({
          ...
          _this6.status = statusList;
        } else {
          _this6.$toast.showToast("获取检测机构失败，请刷新页面");
        }
      });
